...
- Authoritative root `openapi.yaml` contract using OpenAPI 3.2.0 for SwapPulse public/authenticated product functions.
...
- `docs/OPENAPI.md` maintainer guide describing scope, exclusions and contract-update rules.
