...
try {
  ...
  if (ownerKeyRequested) throw new Error('Registration attempted to fetch the registry owner key from Devnet');
  ...
  if (ownerKeyRequested) throw new Error('Fresh registration fetched the registry owner key from Devnet instead of using the host-local env key');
