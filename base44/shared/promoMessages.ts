...
// {BUILD_STATUS}  — replaced with the current build status string (e.g. "alpha")
...
const fr: PromoMessagePools = {
  ...
  valueProps: [
    "SwapPulse est un réseau social décentralisé pour les collectionneurs de cartes Pokémon TCG, construit sur l'AT Protocol. Il est en alpha : les fonctionnalités sont encore en cours de développement.",
    "Nous construisons un endroit où les collectionneurs peuvent vraiment se parler. Pas de pub, pas d'algorithme. C'est l'alpha, les choses peuvent évoluer.",
    "Scannez des cartes, créez des collections, des classeurs, trouvez des échanges, tout au même endroit. C'est gratuit et open-source, et nous sommes encore en alpha, alors soyez indulgents.",
    "Construit sur l'AT Protocol, donc vos posts peuvent apparaître sur Bluesky aussi. Même compte, plus grande portée. Toujours en alpha, toujours en amélioration.",
    "Pas de paywall. Pas de formules premium. Pas de revente de vos données. Juste des collectionneurs qui s'entraident, et nous sommes en alpha, alors attendez-vous à quelques imperfections.",
    "Votre collection, vos posts, vos abonnements. C'est le vôtre. C'est l'alpha et nous construisons activement, mais la vision est claire : des données portables et appartenant aux collectionneurs.",
    "Défis, rencontres, fêtes d'ouverture : l'ambiance du magasin de cartes, en ligne. Nous sommes en alpha, donc certaines choses sont encore en cours d'intégration.",
    "SwapPulse est gratuit et open-source, financé par les dons. Nous sommes en alpha, en train de tester et d'itérer avec la communauté.",
  ],
  featureHooks: [
  ...
  helpValueProps: [
    "SwapPulse est un réseau social décentralisé pour les collectionneurs de Pokémon TCG, construit sur l'AT Protocol. C'est l'alpha et on construit encore.",
...
const it: PromoMessagePools = {
  ...
  valueProps: [
    "SwapPulse è un social network decentralizzato per collezionisti di Pokémon TCG, costruito sull'AT Protocol. È in alpha: le funzionalità sono ancora in costruzione e perfezionamento.",
    "Stiamo costruendo un posto dove i collezionisti possono davvero parlarsi. Niente pubblicità, niente algoritmo. È alpha, quindi le cose possono cambiare.",
    "Scansiona carte, costruisci collezioni, crea binder, trova scambi, tutto in un posto. È gratuito e open-source, e siamo ancora in alpha, quindi portate pazienza.",
    "Costruito sull'AT Protocol, quindi i tuoi post possono apparire anche su Bluesky. Stesso account, maggiore portata. Ancora in alpha, ancora in miglioramento.",
    'Nessun paywall. Nessun livello premium. Nessuna vendita dei tuoi dati. Solo collezionisti che si aiutano, e siamo in alpha, quindi aspettatevi qualche spigolo.',
    "La tua collezione, i tuoi post, i tuoi follow. Sono tuoi. È alpha e stiamo costruendo attivamente, ma la visione è dati portabili e di proprietà dei collezionisti.",
    'Sfide, meetup, pack party: l\'atmosfera del negozio di carte, online. Siamo in alpha quindi qualcosa sta ancora prendendo forma.',
    'SwapPulse è gratuito e open-source, finanziato dalle donazioni. Siamo in alpha, testando e iterando con la comunità.',
  ],
  featureHooks: [
  ...
  helpValueProps: [
    "SwapPulse è un social network decentralizzato per collezionisti di Pokémon TCG, costruito sull'AT Protocol. È alpha e stiamo ancora costruendo.",
...
const es: PromoMessagePools = {
  ...
  valueProps: [
    'SwapPulse es una red social descentralizada para coleccionistas de Pokémon TCG, construida sobre el AT Protocol. Está en alpha: las funciones aún se están construyendo y perfeccionando.',
    'Estamos construyendo un lugar donde los coleccionistas puedan hablar entre ellos. Sin anuncios, sin algoritmo. Es alpha, así que las cosas pueden cambiar.',
    'Escanea cartas, crea colecciones, crea álbumes, encuentra intercambios, todo en un lugar. Es gratis y de código abierto, y todavía estamos en alpha, así que ten paciencia.',
    'Construido sobre el AT Protocol, así que tus publicaciones pueden aparecer en Bluesky también. Misma cuenta, mayor alcance. Todavía en alpha, todavía mejorando.',
    'Sin barreras de pago. Sin niveles premium. Sin vender tus datos. Solo coleccionistas ayudando a coleccionistas, y estamos en alpha, así que espera algunas asperezas.',
    'Tu colección, tus publicaciones, tus seguidores. Son tuyos. Es alpha y estamos construyendo activamente, pero la visión son datos portables y de los coleccionistas.',
    'Retos, quedadas, fiestas de sobres: el ambiente de la tienda de cartas, en línea. Estamos en alpha así que algo aún está tomando forma.',
    'SwapPulse es gratis y de código abierto, financiado por donaciones. Estamos en alpha, probando e iterando con la comunidad.',
  ],
  featureHooks: [
  ...
  helpValueProps: [
    'SwapPulse es una red social descentralizada para coleccionistas de Pokémon TCG, construida sobre el AT Protocol. Está en alpha y seguimos construyendo.',
...
const pt: PromoMessagePools = {
  ...
  valueProps: [
    'SwapPulse é uma rede social descentralizada para colecionadores de Pokémon TCG, construída sobre o AT Protocol. Está em alpha: os recursos ainda estão sendo construídos e refinados.',
    'Estamos construindo um lugar onde os colecionadores possam realmente conversar. Sem anúncios, sem algoritmo. É alpha, então as coisas podem mudar.',
    'Escanear cartas, montar coleções, criar pastas, encontrar trocas, tudo num só lugar. É grátis e open-source, e ainda estamos em alpha, então tenham paciência.',
    'Construído sobre o AT Protocol, então seus posts podem aparecer no Bluesky também. Mesma conta, maior alcance. Ainda em alpha, ainda melhorando.',
    'Sem paywalls. Sem níveis premium. Sem vender seus dados. Só colecionadores se ajudando, e estamos em alpha, então espere algumas arestas.',
    'Sua coleção, seus posts, seus seguidores. São seus. É alpha e estamos construindo ativamente, mas a visão são dados portáteis e de propriedade dos colecionadores.',
    'Desafios, encontros, festas de pacote: a vibe da loja de cartas, online. Estamos em alpha então algo ainda está se juntando.',
    'SwapPulse é grátis e open-source, financiado por doações. Estamos em alpha, testando e iterando com a comunidade.',
  ],
  featureHooks: [
  ...
  helpValueProps: [
    'SwapPulse é uma rede social descentralizada para colecionadores de Pokémon TCG, construída sobre o AT Protocol. É alpha e ainda estamos construindo.',
...
const ja: PromoMessagePools = {
  ...
  valueProps: [
    'SwapPulseは、AT Protocol上に構築された、ポケモンTCGコレクター向けの分散型ソーシャルネットワークです。現在アルファ版で、機能はまだ構築・改良中です。',
    'コレクター同士が実際に語り合える場所を作っています。広告なし、アルゴリズムなし。アルファ版なので、変化があるかもしれません。',
    'カードをスキャン、コレクション構築、バインダー作成、トレード発見、すべて一つの場所で。無料でオープンソース、まだアルファ版なのでご容赦ください。',
    'AT Protocol上に構築されているので、あなたの投稿はBlueskyにも表示できます。同じアカウントで、より大きなリーチ。まだアルファ版、まだ改良中。',
    '課金壁なし。プレミアム階層なし。データ販売なし。ただコレクター同士が助け合うだけ。アルファ版なので、荒い部分もあるかもしれません。',
    'あなたのコレクション、投稿、フォロー。それはあなたのものです。アルファ版で積極的に構築中ですが、ビジョンはポータブルでコレクター所有のデータです。',
    'チャレンジ、ミートアップ、パックパーティー。カードショップの雰囲気をオンラインで。アルファ版なので、まだまとまっている部分もあります。',
    'SwapPulseは無料でオープンソース、寄付で運営されています。アルファ版で、コミュニティと共にテストと反復を重ねています。',
  ],
  featureHooks: [
  ...
  helpValueProps: [
    'SwapPulseはAT Protocol上に構築された、ポケモンTCGコレクター向けの分散型ソーシャルネットワークです。アルファ版で、まだ構築中です。',
...
const zh: PromoMessagePools = {
  ...
  valueProps: [
    'SwapPulse是一个为宝可梦TCG收藏家打造的去中心化社交网络，基于AT Protocol构建。目前处于alpha阶段：功能仍在开发和优化中。',
    '我们正在打造一个收藏家可以真正互相交流的地方。没有广告，没有算法。这是alpha，所以可能会有变化。',
    '扫描卡牌、建立收藏、创建活页夹、寻找交易，全在一个地方。免费且开源，我们还在alpha阶段，请多多包涵。',
    '基于AT Protocol构建，所以你的帖子也可以显示在Bluesky上。同一个账号，更大的触达。仍在alpha，仍在改进。',
    '没有付费墙。没有高级等级。不卖你的数据。只是收藏家互相帮助，我们在alpha阶段，所以会有粗糙的地方。',
    '你的收藏、你的帖子、你的关注。它们是你的。这是alpha，我们在积极开发，但愿景是可移植的、收藏家拥有的数据。',
    '挑战、聚会、开包派对：卡牌店的氛围，在线上。我们在alpha阶段，所以有些还在整合中。',
    'SwapPulse免费且开源，靠捐赠运营。我们在alpha阶段，与社区一起测试和迭代。',
  ],
  featureHooks: [
  ...
  helpValueProps: [
    'SwapPulse是一个为宝可梦TCG收藏家打造的去中心化社交网络，基于AT Protocol构建。目前是alpha阶段，我们还在开发。',
...
const ko: PromoMessagePools = {
  ...
  valueProps: [
    'SwapPulse는 AT Protocol 위에 구축된 포켓몬 TCG 컬렉터를 위한 탈중앙화 소셜 네트워크입니다. 현재 알파 단계이며 기능은 여전히 구축 및 개선 중입니다.',
    '컬렉터들이 실제로 대화할 수 있는 곳을 만들고 있습니다. 광고 없음, 알고리즘 없음. 알파 단계이므로 변화가 있을 수 있습니다.',
    '카드 스캔, 컬렉션 구축, 바인더 만들기, 트레이드 찾기, 모두 한 곳에서. 무료이고 오픈소스이며, 아직 알파 단계이니 너그럽게 봐주세요.',
    'AT Protocol 위에 구축되어, 게시물이 Bluesky에도 표시될 수 있습니다. 같은 계정, 더 큰 도달. 여전히 알파, 여전히 개선 중.',
    '페이월 없음. 프리미엄 등급 없음. 데이터 판매 없음. 컬렉터들이 서로 돕는 것뿐, 그리고 우리는 알파 단계이므로 거친 부분이 있을 수 있습니다.',
    '당신의 컬렉션, 게시물, 팔로우. 그것은 당신의 것입니다. 알파 단계이고 우리는 활발히 구축 중이지만, 비전은 휴대 가능하고 컬렉터 소유의 데이터입니다.',
    '챌린지, 밋업, 팩 파티: 카드샵의 분위기를 온라인으로. 우리는 알파 단계이므로 일부는 아직 정리 중입니다.',
    'SwapPulse는 무료이고 오픈소스이며, 기부로 운영됩니다. 우리는 알파 단계에서 커뮤니티와 함께 테스트하고 반복하고 있습니다.',
  ],
  featureHooks: [
  ...
  helpValueProps: [
    'SwapPulse는 AT Protocol 위에 구축된 포켓몬 TCG 컬렉터를 위한 탈중앙화 소셜 네트워크입니다. 알파 단계이고 아직 구축 중입니다.',
