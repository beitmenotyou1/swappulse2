  ...
  try {
    ...
    if (action === 'config') {
      return Response.json({
        ...
        config: {
          ...
          ready: config.ready,
          ecosystem_ready: config.ecosystemReady,
          account_class_hash: config.accountClassHash,
          ...
          card_nft_address: config.cardNftAddress,
          card_nft_class_hash: config.cardNftClassHash,
          staking_pool_address: config.stakingPoolAddress,
          staking_pool_class_hash: config.stakingPoolClassHash,
          usership_address: config.usershipAddress,
          usership_class_hash: config.usershipClassHash,
          bridge_adapter_address: config.bridgeAdapterAddress,
          bridge_adapter_class_hash: config.bridgeAdapterClassHash,
          ...
          verified_native_token_class_hash: config.verifiedNativeTokenClassHash,
          verified_card_nft_class_hash: config.verifiedCardNftClassHash,
          verified_staking_pool_class_hash: config.verifiedStakingPoolClassHash,
          verified_usership_class_hash: config.verifiedUsershipClassHash,
          verified_bridge_adapter_class_hash: config.verifiedBridgeAdapterClassHash,
    ...
    if (action === 'import_manifest') {
      ...
      const payload = {
        ...
        verified_native_token_class_hash: '',
        verified_card_nft_class_hash: '',
        verified_staking_pool_class_hash: '',
        verified_usership_class_hash: '',
        verified_bridge_adapter_class_hash: '',
        verified_rpc_url: '',
        verified_by: '',
