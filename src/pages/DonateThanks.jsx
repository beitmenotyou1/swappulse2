  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto flex w-full max-w-xl flex-1 flex-col items-center justify-center px-4 text-center">
        ...
        <h1 className="text-2xl font-extrabold">Thank you for supporting SwapPulse!</h1>
        <p className="mt-2 max-w-sm text-sm text-muted-foreground">
          Your generosity keeps the platform free and open-source for every collector. We've emailed you a receipt.
        </p>
        <Link
          to="/"
        ...
        >
          <Home className="h-4 w-4" /> Back to the app
        </Link>
      </main>
    </div>
  );
