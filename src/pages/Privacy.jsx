        ...
        <div className="flex gap-8">
          ...
          <article className="prose prose-sm max-w-2xl flex-1 dark:prose-invert">
            ...
            <ul>
              ...
              <li><strong>PokemonPriceTracker</strong>, Optional RAW, graded sold-price and recent-history enrichment. SwapPulse sends only Pokémon card catalogue metadata such as card name, set and collector number through the backend. No user identity, email, account ID, private collection notes or API key are sent from the browser. Public production display remains disabled unless the provider plan/permission permits SwapPulse's deployment model.</li>
              <li><strong>TCGplayer</strong>, Optional direct market-price cross-check for cards when SwapPulse has authorised TCGplayer developer access covering this use. Requests are made only from the backend using card catalogue metadata and TCGplayer product identifiers. Developer keys and Bearer tokens never ship to the browser, and store/customer/order/inventory data is not used by this integration.</li>
              <li><strong>Impact / TCGplayer affiliate links</strong>, When affiliate tracking is configured, SwapPulse may ask Impact's backend API to create a tracking link for a TCGplayer product URL. SwapPulse does not send your Base44 user ID, email, AT Protocol identity, private collection notes or Web3 identity to create that link. If you choose to follow an affiliate link, Impact and TCGplayer may process click/conversion information under their own privacy and affiliate policies, and SwapPulse may receive commission from qualifying purchases.</li>
