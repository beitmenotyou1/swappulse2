...
const STEPS = [
  ...
  { icon: Scan, title: "Scan your cards", body: "Privately analyse up to 10 card photos, review every TCGDex match, then choose which cards to add.", color: "text-success" },
