...
// External-stream voice space — the original manual Go Live model: the host
// pastes an external stream URL (Twitch/YouTube/etc.); only the host's mic is
// captured in-platform and the stage is simulated. Preserved unchanged from
// the prior implementation.
export default function ExternalStreamSpace({ space: initialSpace }) {
