import {
  ...
  Wallet, Fingerprint, Camera, Coins, Layers as LayersIcon, LifeBuoy,
} from 'lucide-react';
...
export const HELP_GUIDES = [
  ...
  // AI Assistants
  { slug: 'collector-copilot', title: 'Helper', category: 'AI Assistants', icon: Sparkles, description: 'One multilingual, read-only AI front door for collection, card, trade, project, and chain questions.', relatedRoute: '/helper' },
