...
- `README.md` for project-level truth/navigation;
- `docs/USER_GUIDE.md` for end users;
- `docs/PROJECT_ARCHITECTURE.md` for whole-system architecture;
- `docs/SWAPPULSE_V2_LIVE_ARCHITECTURE.md` for live chain specifics;
- `DEPLOYMENT.md` for deployment/ops;
- `CONTRIBUTING.md` for contribution expectations;
- `docs/FORKING_AND_REBRANDING.md` for independent forks;
- `docs/NODE_ARCHITECTURE.md` for decentralisation/node roadmap.
