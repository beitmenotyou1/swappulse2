---
description: Releasing SwapPulse documentation for SwapPulse.
---
...
* [changelog](https://swappulse.gitbook.io/swappulse-docs/changelog): human-readable history, oldest to newest.
* `RELEASE_MANIFEST.json`: ordered machine-readable list of official releases.
* [versioned release notes](https://swappulse.gitbook.io/swappulse-docs/changelog): full release notes for each version.
...
Read [changelog](https://swappulse.gitbook.io/swappulse-docs/changelog) and `RELEASE_MANIFEST.json` and choose the next semantic version.

### 2. Create the release-note file

Copy [release-note template](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/releasing) to, for example:
...
### 3. Update [changelog](https://swappulse.gitbook.io/swappulse-docs/changelog)
