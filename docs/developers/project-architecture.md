---
description: Project Architecture documentation for SwapPulse.
---
...
* End-user behaviour: [user guide](https://swappulse.gitbook.io/swappulse-docs/start-here/user-guide)
* V2 chain detail: [V2 live architecture](https://swappulse.gitbook.io/swappulse-docs/network-and-web3/v2-live-architecture)
* Node roadmap: [node architecture roadmap](https://swappulse.gitbook.io/swappulse-docs/network-and-web3/node-architecture)
* Contribution: [contributor guide](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/contributing)
* Forking: [forking and rebranding guide](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/forking-and-rebranding)
* Change governance: [change protocol](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/change-protocol)
* Deployment: [deployment guide](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/deployment)
