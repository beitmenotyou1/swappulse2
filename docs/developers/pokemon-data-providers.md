---
description: Pokémon Data Providers documentation for SwapPulse.
---

# SwapPulse Pokémon Data Providers and Sources

{% hint style="info" %}
This canonical page consolidates the former provider and data-source references. TCGDex remains the source of truth for card identity; every enrichment source has a narrow, fail-soft role.
{% endhint %}
...
See [third-party notices](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/third-party-notices) and the provider's own current terms before changing how data is displayed, stored, redistributed or monetised.
