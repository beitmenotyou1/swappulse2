---
description: Developer Onboarding documentation for SwapPulse.
---
...
* [documentation home](https://swappulse.gitbook.io/swappulse-docs/) for the whole project;
* [project architecture](https://swappulse.gitbook.io/swappulse-docs/developers/project-architecture) for system boundaries;
* [contributor guide](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/contributing) for contribution standards;
* [change protocol](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/change-protocol) before security-sensitive work.
...
Follow [change protocol](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/change-protocol).
...
Read [forking and rebranding guide](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/forking-and-rebranding).
...
See [contributor guide](https://swappulse.gitbook.io/swappulse-docs/project-maintenance/contributing) for the full process.
