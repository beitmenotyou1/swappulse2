---
description: Getting Started documentation for SwapPulse.
---
...
For the complete end-user guide, see [user guide](https://swappulse.gitbook.io/swappulse-docs/start-here/user-guide).
...
For architecture details, see [project architecture](https://swappulse.gitbook.io/swappulse-docs/developers/project-architecture).
...
The current staking pool is not yet decentralised multi-validator block consensus. See [node architecture roadmap](https://swappulse.gitbook.io/swappulse-docs/network-and-web3/node-architecture) for the node/validator roadmap.
...
* [user guide](https://swappulse.gitbook.io/swappulse-docs/start-here/user-guide) for detailed product usage.
